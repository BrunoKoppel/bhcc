...
public class InvestmentUI extends JPanel {

   // label text for GUI
   protected final static String names[] = { "Investment Account No.",
      "First name", "Last name", "Investment Balance", 
      "Transaction Amount" };
   ...
   public InvestmentUI( int mySize )
   {
      size = mySize;
