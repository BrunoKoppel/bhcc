...
public class deleteEmployee {
    ...
    /**Delete employee */
    public void deleteEmployee(Stage stage, Statement stm, ObservableList<Employee> data, ArrayList<Employee> employees)throws Exception
    {
        int exist=0;
        String query ="delete from employee where id='"+Integer.parseInt(tfId.getText())+"'";
