...
void IntBinaryTree::displayPreOrder(TreeNode *nodePtr, int treeLevel) const
{
    if (nodePtr == root)
    {
        treeLevel = 0;
    ...
    if (nodePtr)
    {
        ...
        displayNode(nodePtr, treeLevel);
        
        treeLevel++;
        
        displayPreOrder(nodePtr->left, treeLevel);
        
        displayPreOrder(nodePtr->right, treeLevel);
...
void IntBinaryTree::displayNode(TreeNode *nodePtr, int treeLevel) const
{
    cout << "(" << setw(2) << treeLevel << ")  ";
    // Display the values in this node.
    cout << "node=" << nodePtr
        << " value=" << setw(4) << nodePtr->value
        << " left=" << setw(8);
...
*---------------------------------------------------------------------------*/
int IntBinaryTree::calculateSubTreeHeight(TreeNode *nodePtr, int subTreeHeight) const
{
    ...
    {
        nodePtr = nodePtr->right;
        subTreeHeight = calculateSubTreeHeight(nodePtr, subTreeHeight);
    }
...
void IntBinaryTree::displayTreeHeight() const
{
	...
	int treeHeight = 0;
	int leftSubtreeHeight = calculateSubTreeHeight(root->left, treeHeight);
	int rightSubtreeHeight = calculateSubTreeHeight(root->right, treeHeight);
